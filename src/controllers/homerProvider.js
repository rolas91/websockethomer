...
module.exports.getOrderByProvider = async (provider) => {
  try {
    return await sequelize.query(
      ...
      orders.status,orders.isCancel,orders.isCount,orders.isCountNow,orders.date,orders.hour,  orders.hour_end,orders.date_end,orders.location,orders.lat,orders.lng,
