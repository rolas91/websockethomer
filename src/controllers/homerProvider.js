...
module.exports.createOrders = async(req, res) => {
    try {
        ...
        let googleinfo = await fetch('https://maps.googleapis.com/maps/api/geocode/json?latlng=' + lat + ',' + lng + '&key=AIzaSyBofvEOcrzbxSfBA7LTFSypr5SX3TT94Dk&sensor=false').then(resp => {
            console.log('loco man',resp);
        })
